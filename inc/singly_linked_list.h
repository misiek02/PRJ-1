...
struct SinglyLinkedList{
    ...
    public:
        ...
        SinglyLinkedList() {this->head = NULL;siz=0;}
        ...
        void insert(const T& newElement, int index); //  inserts elem at the  index position
...
template <typename T>
void SinglyLinkedList<T>::addFront(const T &newElem)
